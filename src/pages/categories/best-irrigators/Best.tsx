...
export default function () {
  return (
    <main>
      ...
      {/* Second Product */}
      <Title titleH2={secondProduct.proAndCons.title} message={secondProduct.proAndCons.subtitle} />
      ...
      <Title titleH2={thirdProduct.proAndCons.title} message={thirdProduct.proAndCons.subtitle} />
      <Product {...thirdProduct.product} list={thirdProduct.list} />
      <Title {...thirdProduct.productDetails} />
      <ProAndCon {...thirdProduct.proAndCons} />


      <Title titleH2={fourthProduct.proAndCons.title} message={fourthProduct.proAndCons.subtitle} />
