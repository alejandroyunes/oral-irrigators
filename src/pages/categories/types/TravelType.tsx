    ...
    <main>
      <HelmetProvider>
        <Helmet>
          <meta
            name='description'
            content='Comparison of the Best Portable Irrigators in 2023 | Dental Irrigator' />
          <title>Comparison of the Best Portable Irrigators in 2023 | Dental Irrigator</title>
        </Helmet>
      </HelmetProvider>
