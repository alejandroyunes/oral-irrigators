    ...
    <main>
      <HelmetProvider>
        <Helmet>
          <meta
            name='description'
            content='Comparison of the Best Wireless and portable Irrigators in 2024 | Dental Irrigator' />
          <title>Comparison of the Best Wireless and portable Irrigators in 2024 | Dental Irrigator</title>
        </Helmet>
      </HelmetProvider>
